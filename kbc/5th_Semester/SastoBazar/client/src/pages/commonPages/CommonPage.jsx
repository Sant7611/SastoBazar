...
const CommonPage = (props) => {
  return (
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold leading-none sm:text-4xl">
              ...
              <span className="text-purple-500">{props.subtitle}</span>
            </h2>

            <p className="mb-4 text-gray-500">{props.desc1}</p>
            <>
              <p className="mb-4 text-gray-500">{props.desc2}</p>
            </>
            <Link
              to={props.visit}
    ...
    <MoreAbout />
      {/* <div className="flex font-poppins px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:py-20">
        <div className="grid gap-8 lg:grid-cols-2 ">
          <img
            src={props.imageAbout}
            alt="Sasto Bazar"
